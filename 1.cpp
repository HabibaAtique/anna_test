...
public:
    FridgeItem(const string& name, const string& useBy, const string& location)
        : FoodItem(name, useBy), location(location) {}
...
int main() {
    ...
    string itemLocation, itemPosition;
    ...
    while (true) {
        ...
        switch (choice) {
            case 1:
                ...
                inventoryManager.addItem(new FridgeItem(itemName, itemUseBy, itemLocation));
                break;
            case 2:
